...
class ControladorPantallaPrincipalDeColeccion: UICollectionViewController {
    ...
    */
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let celda : VistaDeCelda = collectionView.dequeueReusableCell(withReuseIdentifier: IdentificadorDeCelda, for: indexPath) as! VistaDeCelda//se cambia por Indentificador de celda
        
        celda.etiqueta.text = "\(indexPath)"
    
        // Configure the cell
    
        return celda //se cambia
    }
